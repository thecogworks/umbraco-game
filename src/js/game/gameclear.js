...
GameClear.prototype.preload = function(){
     game.load.image('title_select', 'assets/img/ui/titleselector.png');
}

GameClear.prototype.create = function(){
     init();
    ...
    game.add.text(16, 16, 'Game Clear!', {font: '16px Arial', fill: '#FFF'});
    game.add.text(this.selPosX, this.selPosY[0], 'Re-play level', {font: '10px Arial', fill: '#FFF'});
...
GameClear.prototype.update = function() {
