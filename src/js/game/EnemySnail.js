function EnemySnail(X, Y){
    Enemy.call(this, X, Y, 'enemysnail');
...
EnemySnail.prototype = Object.create(Enemy.prototype);
EnemySnail.prototype.constructor = EnemyMinion;

EnemySnail.prototype.update = function(){
    this.updateActor();
    this.fsm.update();
};

EnemySnail.prototype.checkSeekBox = function(posKey, target){
    var detected = false;
    switch(posKey){
        case 'left':
...
EnemySnail.prototype.checkAttackBox = function (target){
    var detected = false;
